...
namespace Drupal\dsi_media\Form;
...
/**
 * Provides form for managing Dsi Media settings form.
 */
class MediaSettingsForm extends ConfigFormBase {
  ...
  /**
   * Constructs a new Dsi Media settings form.
   *
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $config = $this->config('dsi_media.settings');
    ...
    $form['use_blazy_blurry'] = [
      ...
      '#description' => $this->t('Dsi uses Blazy to lazy-load offscreen images. This setting enhances Dsi to lazy-load images with a low-res blurred image effect. Switching this setting off (<em>not recommended</em>) will fallback to Blazy pixel loader as configured in <a href="@blazy_settings_link">Blazy UI</a> Note that you’ll need to enable Blazy UI module to configure it.', ['@blazy_settings_link' => $blazy_settings_link]),
