 ...
 *   translatable = FALSE,
 *   admin_permission = "administer attachment entities",
 *   entity_keys = {
 *     "id" = "id",
 *     "uuid" = "uuid",
 *     "uid" = "user_id",
...
class Attachment extends ContentEntityBase implements AttachmentInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['user_id'] = BaseFieldDefinition::create('entity_reference')
      ...
      ->setDescription(t('The user ID of author of the Attachment entity.'))
    ...
    $fields['name'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Name'))
      ->setDescription(t('The name of the Attachment entity.'))
      ->setSettings([
        'max_length' => 50,
        'text_processing' => 0,
      ])
    ...
    $fields['status']->setDescription(t('A boolean indicating whether the Attachment is published.'))
      ->setDisplayOptions('form', [
