/**
 * @file
 * Behaviors of Dsi hero slider media for Youtube video scripts.
 */
...
(function ($, Drupal) {
  ...
  Drupal.behaviors.varbaseHeroSliderMedia_youtube = {
    attach: function (context, settings) {
      var mediaSliders = $('.slick--view--dsi-slider-media .slick__slider', context);
      // On before slide change.
      mediaSliders.on('beforeChange', function (event, slick, currentSlide, nextSlide) {
        var currentVideo = $('.slide--' + currentSlide + '.slick-active').find('.varbase-video-player iframe[src*="youtube.com"]', context);
