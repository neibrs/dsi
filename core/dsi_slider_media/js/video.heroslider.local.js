/**
 * @file
 * Behaviors of Dsi hero slider media for local video scripts.
 */
  ...
  Drupal.behaviors.varbaseHeroSliderMedia_local_video = {
    attach: function (context, settings) {
      $(window).on('load', function () {
        ...
        $('.slick--view--dsi-slider-media .slick__slider', context).on('beforeChange', function (event, slick, currentSlide, nextSlide) {
        ...
        $('.slick--view--dsi-slider-media', context).each(function () {
        ...
        if ($('.slick--view--dsi-slider-media .varbase-video-player video', context).length > 0) {
          var player = $('.slick--view--dsi-slider-media .varbase-video-player video', context).get(0);
