...
namespace Drupal\small_title\Render\MainContent;

use Drupal\Core\Display\ContextAwareVariantInterface;
use Drupal\Core\Display\PageVariantInterface;
use Drupal\Core\Render\MainContent\HtmlRenderer as HtmlRendererBase;
...
/**
 */
class HtmlRenderer extends HtmlRendererBase {
  ...
  protected function prepare(array $main_content, Request $request, RouteMatchInterface $route_match) {
    ...
    // page display variant to do that and building that page display variant.
      ...
      $get_small_title = function (array $main_content) use ($request, $route_match) {
        return isset($main_content['#small_title']) ? $main_content['#small_title'] : $this->titleResolver->getSmallTitle($request, $route_match->getRouteObject());
      };
      $small_title = $get_small_title($main_content);
