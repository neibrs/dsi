...
use Drupal\dsi_device\Entity\Device;

/**
 * Provides dynamic permissions for Device of different types.
 *
 * @ingroup dsi_device
 */
class DevicePermissions {
   ...
   *
   * @return array
   *   The Device by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (Device::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\dsi_device\Entity\Device $type
   *   The Device type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(Device $type) {
    $type_id = $type->id();
