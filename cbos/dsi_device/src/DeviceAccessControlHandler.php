 ...
 *
 * @see \Drupal\dsi_device\Entity\Device.
 */
class DeviceAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account) {
    /** @var \Drupal\dsi_device\Entity\DeviceInterface $entity */
    ...
    switch ($operation) {
      ...
      case 'view':
        ...
        if (!$entity->isPublished()) {
          ...
          return AccessResult::allowedIfHasPermission($account, 'view unpublished device');
        }
        ...
        return AccessResult::allowedIfHasPermission($account, 'view published device');
      ...
      case 'update':
        ...
        return AccessResult::allowedIfHasPermission($account, 'edit device');
      ...
      case 'delete':
        ...
        return AccessResult::allowedIfHasPermission($account, 'delete device');
    }
  ...
  protected function checkCreateAccess(AccountInterface $account, array $context, $entity_bundle = NULL) {
    return AccessResult::allowedIfHasPermission($account, 'add device');
  }
