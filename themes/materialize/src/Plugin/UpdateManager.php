...
class UpdateManager extends PluginManager {
  ...
  public function __construct(Theme $theme) {
    ...
    $this->pluginDefinitionAnnotationName = 'Drupal\materialize\Annotation\BootstrapUpdate';
    $this->pluginInterface = 'Drupal\materialize\Plugin\Update\UpdateInterface';
   ...
   *
   * @see \Drupal\materialize\Plugin\UpdateManager::getLatestSchema
   */
