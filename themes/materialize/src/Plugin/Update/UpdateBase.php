...
namespace Drupal\materialize\Plugin\Update;
...
class UpdateBase extends PluginBase implements UpdateInterface {
   ...
   *
   * @see \Drupal\materialize\Plugin\Update\UpdateBase::getSeverity
   */
   ...
   * @deprecated 8.x-3.0-rc2, will be removed before 8.x-3.0 is released.
   *
   * @see \Drupal\materialize\Plugin\Update\UpdateBase::getLabel
   */
