 ...
 *
 * @MaterializeAlter("theme_suggestions")
 */
  ...
  public function alter(&$suggestions, &$context1 = NULL, &$hook = NULL) {
    ...
    switch ($hook) {
      case 'links':
        ...
        //   // @see \Drupal\materialize\Plugin\Prerender\Dropbutton::preRenderElement()
        //   if ($suggestion = Unicode::substr($variables['theme_hook_original'], 17)) {
        //     $suggestions[] = 'materialize_dropdown' . $suggestion;
        //   }
        //   $suggestions[] = 'materialize_dropdown';
        // }
        break;

      case 'fieldset':
      case 'details':
        /*if ($variables->element && $variables->element->getProperty('materialize_panel', TRUE)) {
        $suggestions[] = 'materialize_panel';
        }*/
        break;
