...
class Attributes extends ArrayObject {
   ...
   *
   * @see \Drupal\materialize\Utility\ArrayObject::offsetGet()
   */
  ...
  public function &getClasses() {
    ...
    // todo: cast to array the $classes - fix features form error.
   ...
   *   TRUE or FALSE
   *
   * @see \Drupal\materialize\Utility\ArrayObject::offsetExists()
   */
   ...
   *
   * @see \Drupal\materialize\Utility\ArrayObject::offsetUnset()
   */
   ...
   *
   * @see \Drupal\materialize\Utility\ArrayObject::offsetSet()
   */
   ...
   *
   * @see \Drupal\materialize\Utility\ArrayObject::merge()
   */
