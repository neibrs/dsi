 ...
 * @ingroup utility
 *
 * @see \Drupal\materialize\Utility\Attributes
 * @see \Drupal\materialize\Utility\Element
 * @see \Drupal\materialize\Utility\Variables
 */
class DrupalAttributes extends ArrayObject {
   ...
   * @return $this
   *
   * @see \Drupal\materialize\Utility\Attributes::addClass()
   */
   ...
   *
   * @see \Drupal\materialize\Utility\Attributes::getAttribute()
   */
   ...
   *
   * @see \Drupal\materialize\Utility\Attributes::getClasses()
   */
   ...
   *   TRUE or FALSE
   *
   * @see \Drupal\materialize\Utility\Attributes::hasAttribute()
   */
   ...
   *   TRUE or FALSE
   *
   * @see \Drupal\materialize\Utility\Attributes::hasClass()
   */
   ...
   * @return $this
   *
   * @see \Drupal\materialize\Utility\Attributes::removeAttribute()
   */
   ...
   * @return $this
   *
   * @see \Drupal\materialize\Utility\Attributes::removeClass()
   */
   ...
   * @return $this
   *
   * @see \Drupal\materialize\Utility\Attributes::replaceClass()
   */
   ...
   * @return $this
   *
   * @see \Drupal\materialize\Utility\Attributes::setAttribute()
   */
   ...
   * @return $this
   *
   * @see \Drupal\materialize\Utility\Attributes::setAttributes()
   */
