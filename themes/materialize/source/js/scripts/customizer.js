  ...
  Drupal.behaviors.customizer = {
    attach: function attach(context) {
      ...
      $(document).ready(function() {
        ...
        let ps_theme_customiser = new PerfectScrollbar(".theme-cutomizer", {
        ...
        $(".menu-color-option, .menu-bg-color-option").click(function(e) {
          ...
          let menu_color = $(this).attr("data-color");
          if (menuBgDefault) {
            menuDark(true);
        ...
        $(".navbar-color-option").click(function(e) {
          ...
          $(this).addClass("selected");
          let navbar_color = $(this).attr("data-color");
          navbarDark(true);
