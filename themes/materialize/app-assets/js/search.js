...
(function ($, Drupal, drupalSettings) {
  Drupal.behaviors.search = {
    attach: function attach(context) {
      let contentOverlay = $(".content-overlay");
      let searchListLi = $(".search-list li"),
      ...
      $(function () {
        ...
        if ($(".search-list").length > 0) {
          let ps_search_nav = new PerfectScrollbar(".search-list", {
            wheelSpeed: 2,
        ...
        if (searchListSm.length > 0) {
          let ps_search2_nav = new PerfectScrollbar(".search-list-sm", {
            wheelSpeed: 2,
            wheelPropagation: false,
            minScrollbarLength: 20
          });
        ...
        // Quick search
        //-------------
        let $filename = $(".header-search-wrapper .header-search-input,.search-input-sm .search-box-sm").data("search");
          ...
          if (e.keyCode !== 38 && e.keyCode !== 40 && e.keyCode !== 13) {
            ...
            if (value != "") {
              ...
              $.getJSON("../../../app-assets/data/" + $filename + ".json", function (data) {
                ...
                let $mainPage = $("#page-search-title").html();
                let defaultList = $("#default-search-main").html();
        ...
        $(window).on("keydown", function (e) {
          ...
          if (e.keyCode === 13 && $(".search-list li.current_item").length > 0) {
            let selected_item = $("li.current_item a");
