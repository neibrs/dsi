 ...
 *   links = {
 *     "canonical" = "/quick_code/{quick_code}",
 *     "delete-form" = "/quick_code/{quick_code}/delete",
 *     "edit-form" = "/quick_code/{quick_code}/edit",
 *     "add-page" = "/quick_code/add",
 *     "add-form" = "/quick_code/add/{quick_code_type}",
 *   },
...
class QuickCode extends ContentEntityBase implements QuickCodeInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['label'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Label', [], ['context' => 'QuickCode']))
      ->setRequired(TRUE)
    ...
    $fields['color'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Color'))
      ->setDefaultValueCallback('Drupal\quick_code\Entity\QuickCode::getRandomColor')
      ->setDisplayOptions('view', [
        'type' => 'string',
        'weight' => 0,
      ])
