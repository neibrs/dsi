 ...
 *   },
 *   links = {
 *     "add-form" = "/quick_code/type/add",
 *     "delete-form" = "/quick_code/type/{quick_code_type}/delete",
 *     "canonical" = "/quick_code/type/{quick_code_type}",
 *     "edit-form" = "/quick_code/type/{quick_code_type}/edit",
 *     "collection" = "/quick_code",
 *   },
 *   config_export = {
 *     "id",
 *     "label",
