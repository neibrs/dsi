 ...
 *
 * @Action(
 *   id = "person_enable_user",
 *   label = @Translation("enable user account for selected person"),
 *   type = "person"
 * )
 */
class EnableUser extends ActionBase implements ContainerFactoryPluginInterface {
