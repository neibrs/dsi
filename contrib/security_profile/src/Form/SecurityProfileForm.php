...
namespace Drupal\security_profile\Form;
...
/**
 * Form controller for Security profile edit forms.
 *
 * @ingroup security_profile
 */
class SecurityProfileForm extends ContentEntityForm {
  ...
  /**
   * Constructs a new SecurityProfileForm.
   *
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    $form_state->setRedirect('entity.security_profile.canonical', ['security_profile' => $entity->id()]);
  }
