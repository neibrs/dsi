...
/**
 * Form controller for Lookup edit forms.
 *
 * @ingroup lookup
 */
class LookupForm extends ContentEntityForm {
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    $form_state->setRedirect('entity.lookup.canonical', ['lookup' => $entity->id()]);
  }
