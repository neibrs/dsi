...
/**
 * Form controller for Responsibility edit forms.
 *
 * @ingroup responsibility
 */
class ResponsibilityForm extends ContentEntityForm {
  ...
  /**
   * Constructs a new ResponsibilityForm.
   *
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    $form_state->setRedirect('entity.responsibility.canonical', ['responsibility' => $entity->id()]);
  }
